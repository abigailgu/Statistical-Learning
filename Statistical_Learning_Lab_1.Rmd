...
p <- ggplot(data = week_cycles_freq,aes(x = time_hour,
  ...
  geom_point(data = week_cycles_min,aes(x=time_hour,y=week_cycles_min$frequency, color = "lightblue"),size = 7)+
...
grid.arrange(g, p, layout_matrix = matrix(c(1,2,2, 2, 2), ncol = 5),
