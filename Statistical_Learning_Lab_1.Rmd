...
plot_del <- plot_usmap(regions = "states",labels = TRUE,exclude =  c("AK","HI"), size = 0.5,
  ...
  scale_color_manual(name = "",values = c("green","purple","blue","orange","red"),
    ...
    labs(title = '<b>% of Flight Departures Delayed > 15 Min</b><br> Airport = EWR Year = 2013',
         caption = "Click line endpoint to see that airport departures") +
...
לצבוע יפה את הגרפים החמודים שלי 
```{r}
